...
Write exactly one assertion per criterion, using its criterion id, in one of two kinds:
...
- Ids look like <CONDITION_3>. They are opaque: copy them character for character and never \
invent or alter one.
